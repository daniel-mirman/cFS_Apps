...
image= glob.glob("/Users/danielmirman/Desktop/Moon_Photo1.jpg")[0]
...
print('Number of stars counted Photo 1: ', numStars1)


blobs_dog = blob_dog(grayscale, max_sigma=30, threshold=.1)
blobs_dog[:, 2] = blobs_dog[:, 2] * sqrt(2)
numStars2= len(blobs_dog)
print('Number of stars counted Photo 2: ', numStars2)


blobs_doh = blob_doh(grayscale, max_sigma=30, threshold=.1)
numStars3= len(blobs_doh)
print('Number of stars counted Photo 3: ', numStars3)
